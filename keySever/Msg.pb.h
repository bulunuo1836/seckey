...
// bytes severID = 4;
inline void RespondMsg::clear_severid() {
  severid_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& RespondMsg::severid() const {
  // @@protoc_insertion_point(field_get:RespondMsg.severID)
  return severid_.GetNoArena();
}
inline void RespondMsg::set_severid(const std::string& value) {
  
  severid_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:RespondMsg.severID)
}
inline void RespondMsg::set_severid(std::string&& value) {
  
  severid_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:RespondMsg.severID)
}
inline void RespondMsg::set_severid(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  severid_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:RespondMsg.severID)
}
inline void RespondMsg::set_severid(const void* value, size_t size) {
  
  severid_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:RespondMsg.severID)
}
inline std::string* RespondMsg::mutable_severid() {
  
  // @@protoc_insertion_point(field_mutable:RespondMsg.severID)
  return severid_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RespondMsg::release_severid() {
  // @@protoc_insertion_point(field_release:RespondMsg.severID)
  
  return severid_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RespondMsg::set_allocated_severid(std::string* severid) {
  if (severid != nullptr) {
  ...
  severid_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), severid);
  // @@protoc_insertion_point(field_set_allocated:RespondMsg.severID)
}
